...
(function() {
    ...
    const config = {
        ...
        agentPhoto: scriptTag?.getAttribute('data-agent-photo') || 'https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?w=200&h=200&fit=crop&crop=face&facepad=2.5',
