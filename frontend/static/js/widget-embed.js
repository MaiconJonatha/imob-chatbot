...
(function() {
    ...
    const config = {
        ...
        agentPhoto: scriptTag?.getAttribute('data-agent-photo') || 'https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?w=400&h=400&fit=crop&crop=face&facepad=2',
